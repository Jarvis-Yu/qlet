...
class QItem(Item):
    ...
    def __init__(
        ...
        self.actual_align_x: number = 0
        self.actual_align_y: number = 0
    ...
    def _on_x_change(self) -> None:
        self._root_component.left = self.x
...
if __name__ == "__main__":
    ...
    def main(page: ft.Page):
        ...
        #     bgcolor="#FF0000",
        #     expand=True,
        #     # alignment=ft.Alignment(1.2, 1.2),
        #     padding=ft.Padding(-50, -40, -30, -20),
        #     # padding=ft.Padding(-100, 0, 0, 0),
        # )
